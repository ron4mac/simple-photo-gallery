...
<dialog id="newGdlg">
	<form action="" method="POST">
		<label>
			Gallery Name:<br>
			<input type="text" class="textin" name="galnam" required autofocus>
		</label>
		<label>
			Server Location:<br>
			<input type="text" class="textin" name="galloc" required autofocus>
		</label>
		<label>
			Admin User Name:<br>
			<input type="text" class="textin" name="admnam" required autofocus>
		</label>
		<label>
			Admin Password:<br>
			<input type="text" class="textin" name="admpass" required autofocus>
		</label>
		<div class="dbuts">
